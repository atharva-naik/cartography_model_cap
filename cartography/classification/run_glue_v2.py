...
from cartography.classification.glue_utils import adapted_glue_convert_examples_to_featuresV2 as convert_examples_to_features
...
from cartography.classification.params import ParamsV2, save_args_to_file
...
def main():
    ...
    if args_from_cli.config.endswith("json"):
        ...
        other_args = json.load(open(args_from_cli.config))
