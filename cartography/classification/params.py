...
class Params:
    ...
    def __init__(self, MODEL_CLASSES, ALL_MODELS, processors, configs):
        ...
        self.per_gpu_train_batch_size: int = configs.get(
            "per_gpu_train_batch_size", 96)

        # Batch size per GPU/CPU for evaluation.
        self.per_gpu_eval_batch_size: int = configs.get(
            "per_gpu_eval_batch_size", 96)

        # Number of updates steps to accumulate before
        # performing a backward/update pass.
        self.gradient_accumulation_steps: int = configs.get(
        ...
        self.eval_all_checkpoints: bool = configs.get(
        ...
        self.overwrite_output_dir: bool = configs.get(
...
def save_args_to_file(params: Params, mode: str = ""):
    ...
    with open(os.path.join(params.output_dir, f"cartography_config_{mode}.json"), "w") as outfile:
        ...
        outfile.write(json.dumps(writable_params,
