...
class AdaptedInputFeatures(InputFeatures):
    def __init__(self, *args, example_id=None, **kwargs):
        super(AdaptedInputFeatures, self).__init__(*args, **kwargs)
        # self.attention_mask = attention_mask
        # self.token_type_ids = token_type_ids
        # self.label = label
        self.example_id = example_id # the new attribute added.


def adapted_glue_convert_examples_to_featuresV2(
    examples,
    tokenizer,
    max_length=512,
    task=None,
